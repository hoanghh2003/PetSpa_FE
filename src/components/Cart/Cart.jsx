...
import { faCartShopping, faCircleCheck, faMoneyCheckDollar} from '@fortawesome/free-solid-svg-icons';
            ...
            <div id="wizard-checkout" className="bs-stepper wizard-icons wizard-icons-example mb-5">
              <div className="bs-stepper-header m-auto border-0 py-4">
                ...
                <div className="step" data-target="#checkout-payment">
                  <button type="button" className="step-trigger" onClick={() => setCurrentStep(3)}>
                    <span className="bs-stepper-icon">
                      <svg viewBox="0 0 58 54">
                ...
                <div className="step" data-target="#checkout-confirmation">
                  <button type="button" className="step-trigger" onClick={() => setCurrentStep(4)}>
                    <span className="bs-stepper-icon">
                      <svg viewBox="0 0 58 54">
              ...
              <div className="bs-stepper-content border-top">
                <form id="wizard-checkout-form" onSubmit={(e) => e.preventDefault()}>
                  {currentStep === 1 && (
                                ...
                                <div className="flex-grow-1">
                                  <div className="row">
                                    <div className="col-md-8">
                                      ...
                                      <div className="read-only-ratings mb-3" data-rateyo-read-only="true"></div>
                                      <input type="number" className="form-control form-control-sm w-px-100 mt-2" value="1" min="1" max="5" />
                                    </div>
                      ...
                      <div className="row">
                        <div className="col-lg-8 mb-3">
                          ...
                          <div className="row g-3">
                            ...
                            <div className="col-12">
                              <textarea className="form-control" rows="3" placeholder="Order Notes"></textarea>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="col-lg-4">
                          ...
                          <div className="d-grid mt-2">
                            <button type="button" className="btn btn-label-primary btn-prev" onClick={handlePrev}>Previous</button>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="col-xxl-9 col-lg-8">
                          <ul className="nav nav-pills card-header-pills mb-3" id="paymentTabs" role="tablist">
                            <li className="nav-item" role="presentation">
                              <button
                                className={`nav-link ${activeTab === 'pills-cc' ? 'active' : ''}`}
                                id="pills-cc-tab"
                                data-bs-toggle="pill"
                            ...
                            <li className="nav-item" role="presentation">
                              <button
                                className={`nav-link ${activeTab === 'pills-cod' ? 'active' : ''}`}
                                id="pills-cod-tab"
                                data-bs-toggle="pill"
                            ...
                            <li className="nav-item" role="presentation">
                              <button
                                className={`nav-link ${activeTab === 'pills-gift-card' ? 'active' : ''}`}
                                ...
                                aria-selected={activeTab === 'pills-gift-card'}
                                onClick={() => handleTabChange('pills-gift-card')}
                              >
                                Gift Card
                              </button>
                            </li>
                          ...
                          <div className="tab-content px-0" id="paymentTabsContent">
                            {/* Credit card */}
                            <div className={`tab-pane fade ${activeTab === 'pills-cc' ? 'show active' : ''}`} id="pills-cc" role="tabpanel" aria-labelledby="pills-cc-tab">
                              <div className="row g-3">
                                <div className="col-12">
                                  ...
                                  <div className="input-group input-group-merge">
                                    ...
                                    <span className="input-group-text cursor-pointer p-1" id="paymentCard2"><span className="card-type"></span></span>
                                  </div>
                                </div>
                                ...
                                <div className="col-6 col-md-3">
                                  ...
                                  <div className="input-group input-group-merge">
                                    ...
                                    <span className="input-group-text cursor-pointer" id="paymentCardCvv2"><i className="fas fa-question-circle text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="Card Verification Value"></i></span>
                                  </div>
                                </div>
                                <div className="col-12">
                            ...
                            {/* COD */}
                            <div className={`tab-pane fade ${activeTab === 'pills-cod' ? 'show active' : ''}`} id="pills-cod" role="tabpanel" aria-labelledby="pills-cod-tab">
                              <p>Cash on Delivery is a type of payment method where the recipient makes payment for the order at the time of delivery rather than in advance.</p>
                              <button type="button" className="btn btn-primary btn-next">Pay On Delivery</button>
                            </div>
              
                            {/* Gift card */}
                            <div className={`tab-pane fade ${activeTab === 'pills-gift-card' ? 'show active' : ''}`} id="pills-gift-card" role="tabpanel" aria-labelledby="pills-gift-card-tab">
                        ...
                        <div id="checkout-confirmation" className="content">
                          <div className="row mb-3">
                            <div className="col-12 col-lg-8 mx-auto text-center mb-3">
                              ...
                              <p>
                                Your order <a href="javascript:void(0)">#1536548131</a> has been placed!
                              </p>
                              <p>
                                We sent an email to <a href="mailto:john.doe@example.com">john.doe@example.com</a> with your order confirmation and receipt. If the email hasnt arrived within two minutes, please check your spam folder to see if the email was routed there.
                              </p>
                              <p>
                                <span className="fw-medium"><FontAwesomeIcon icon={faClock} />{" "} Time placed:&nbsp;</span> 25/05/2020 13:35pm
                              </p>
                            </div>
                          </div>
                                      ...
                                      <div className="row">
                                        <div className="col-md-8">
                                          ...
                                          <div className="text-muted mb-1 d-flex flex-wrap">
                                            ...
                                            <a href="javascript:void(0)" className="me-3">Apple</a> 
