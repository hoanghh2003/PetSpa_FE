                  ...
                  <ul className="main_menu_list unorder_list_center">
                    ...
                    <li className="dropdown">
                      ...
                      >
                        ...
                        <li>
                          <a href="shipping_info.html">Shipping Info</a>
                        </li>
                      </ul>
                    </li>
                    <li className="dropdown">
          ...
          >
            ...
            <div className="container">
              <div className="banner_content">
                ...
                <a className="btn btn_primary" href="service.html">
                ...
                <div className="banner_services_wrap row">
                  <div className="col">
                    <div className="iconbox_item iconbox_overicon">
                      ...
                      <a className="item_global_link" href="service.html" />
                    </div>
                  </div>
                  <div className="col">
                    <div className="iconbox_item iconbox_overicon">
              ...
              <div className="row justify-content-center">
                <div className="col col-lg-4">
                  ...
                  >
                    ...
                    <a className="btn_unfill" href="service_details.html">
            ...
            <div className="container">
              <div className="section_title text-center">
                <h2 className="title_text">
                  <span className="sub_title">favorite pets</span>
                  Our Gallery
                </h2>
                <p className="mb-0">
                  Tristique nulla aliquet enim tortor at auctor urna nunc.
              ...
              <div className="row">
                <div className="col col-lg-4 col-md-6 col-sm-6">
                  <div className="gallery_item">
                    <div className="item_image">
                      <img
                        src="src/assets/images/gallery/gallery_img_1.jpg"
                        alt="Pet Image"
                      />
                    </div>
                ...
                <div className="col col-lg-4 col-md-6 col-sm-6">
                  <div className="gallery_item">
                    <div className="item_image">
                      <img
                        src="src/assets/images/gallery/gallery_img_2.jpg"
                        alt="Pet Image"
                      />
                    </div>
                    <a className="item_content" href="#!">
                ...
                <div className="col col-lg-4 col-md-6 col-sm-6">
                  <div className="gallery_item">
                    <div className="item_image">
                      <img
                        src="src/assets/images/gallery/gallery_img_3.jpg"
                        alt="Pet Image"
                      />
                    </div>
                    <a className="item_content" href="#!">
                ...
                <div className="col col-lg-4 col-md-6 col-sm-6">
                  <div className="gallery_item">
                    <div className="item_image">
                      <img
                        src="src/assets/images/gallery/gallery_img_4.jpg"
                        alt="Pet Image"
                      />
                    </div>
                    <a className="item_content" href="#!">
                ...
                <div className="col col-lg-4 col-md-6 col-sm-6">
                  <div className="gallery_item">
                    <div className="item_image">
                      <img
                        src="src/assets/images/gallery/gallery_img_5.jpg"
                        alt="Pet Image"
                      />
                    </div>
                    <a className="item_content" href="#!">
                ...
                <div className="col col-lg-4 col-md-6 col-sm-6">
                  <div className="gallery_item">
                    <div className="item_image">
                      <img
                        src="src/assets/images/gallery/gallery_img_6.jpg"
                        alt="Pet Image"
                      />
                    </div>
                    <a className="item_content" href="#!">
              ...
              <div className="row align-items-center">
                ...
                <div className="col col-lg-4">
                  <div className="feature_content">
                    ...
                    <a className="btn btn_primary" href="service_details.html">
                      <i className="fas fa-paw" />
                      Get Service
                    </a>
                  </div>
          ...
          <section className="team_section section_space_lg">
            <div className="container">
              ...
              <div className="text-center">
                <a className="btn btn_primary" href="team.html">
                  <i className="fas fa-paw" />
                  Our Team
                </a>
              </div>
